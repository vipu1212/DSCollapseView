...
public class DSCollapseView : UIView {
    ...
    required public init(coder aDecoder: NSCoder) {
        ...
        self.addGestureRecognizer(UIPanGestureRecognizer(target: self, action: "onViewDragged:"))
    ...
    func onViewDragged(gesture : AnyObject) {
        ...
        // RESET POINT
        gesture.setTranslation(CGPoint.zero, inView: gesture.view)
    }
